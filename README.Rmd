...
## Wnioski
Analiza danych zawarta w projekcie wykazała, że za karłowacenie śledzi na przestrzeni lat odpowiadają przede wszystkim wzrost temperatury wody oraz spadek ilości narybku. Można pokusić się o wskazanie wzrostu połowów (wynikających z większego popytu na ryby) oraz zjawiska globalnego ocieplenia jako główne czynniki powodujące obserwowane zjawisko.
...
Jak widać najbardziej istotne cechy to: temperatura przy powierzchni wody oraz roczny narybek. O ile miesiąc połowu ma bardzo duże znaczenie w regresji, to dla naszej analizy danych na przestrzeni lat nie ma on znaczenia.
